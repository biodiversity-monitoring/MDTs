...
#' 1. Checks if the input data contains the required columns.
#' 2. Converts LHS_strategy to a factor.
#' 3. Optionally log-transforms the data based on the log_transform parameter.
#' 4. Creates a 3D scatterplot using (potentially log-transformed) values of SLA, Height, and Seed Mass.
#' 5. Colors points based on LHS strategy.
#' 6. Adds a legend to identify different LHS strategies.
#'
