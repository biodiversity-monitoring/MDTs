...
#' Perform nested principal component analysis for ecological niche periodicity
#'
#' This function conducts a two-level principal component analysis (PCA) to analyze
